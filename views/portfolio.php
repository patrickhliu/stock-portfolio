<?php
/* 
 * This is the view for a user's portfolio.  
 * We need to setup these variables: user id, user object with that id, and a record
 * which will do the sql query to pull the user's information from the database.  
 * $record will be a multidimensional array where each array is a record of each 
 * stock owned by that user. 
